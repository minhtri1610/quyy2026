    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100 py-5">
        <div class="reg-content card p-4 p-md-5 shadow-lg themed-card">
            ...
            <div class="logo-head text-center z-index-2 position-relative mb-3">
                <img width="85px" src="<?php echo e(asset('images/icon_banhxephap.png')); ?>" alt="Pháp Luân" class="shadow-sm rounded-circle p-1 bg-white border-gold">
            </div>
            ...
            <form action="<?php echo e(route('client.quyy.store')); ?>" method="POST" class="position-relative z-index-2">
                <?php echo csrf_field(); ?>
                <div class="row mb-3">
                    <div class="col-md">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="info-section mb-4 text-center">
                    ...
                    <p class="mb-0 text-dark"><i class="bi bi-headset text-danger"></i> <b>Hỗ trợ kỹ thuật: <span class="text-danger"><?php echo e(config('conts.infos.phone_support')); ?></span></b></p>
                </div>
...
<?php echo $__env->make('client.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/client/temporary-users/create.blade.php ENDPATH**/ ?>