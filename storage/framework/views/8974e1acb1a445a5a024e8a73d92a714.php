<?php $__env->startPush('css'); ?>
    ...
    <style>
        ...
        .certificate::before {
            ...
            background-image: url("<?php echo e(asset('/images/lotus-icon.png')); ?>");
                ...
                <div class="certificate-content">
                    ...
                    <div class="details">
                        ...
                        <div class="info-row">
                            ...
                            <span class="value d-name"><?php echo e($user->name); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="label">Pháp danh:</span>
                            <span class="value d-name"><?php echo e($user->nickname ?? '...'); ?></span>
                        </div>
                        <div class="info-row" style="flex-direction: row; align-items: flex-end;">
                            <span class="label">Giới tính:</span>
                            <span class="value"
                                style="flex-grow: 0; padding-right: 25px; min-width: 60px;"><?php echo e($user->gender == 'male' ? 'Nam' : 'Nữ'); ?></span>
                            <span class="label" style="margin-left: 15px;">Ngày sinh:</span>
                            <span
                                class="value"><?php echo e($user->birth_date ? date('d/m/Y', strtotime($user->birth_date)) : '...'); ?></span>
                        </div>
                    ...
                    <div class="footer">
                        <div class="left-section">
                            <p>Số Điệp/Mã: <span class="val"><?php echo e($user->uid_code); ?></span></p>
                        </div>
                        <div class="right-section">
                            <p>Ngày <span class="val"><?php echo e(date('d', strtotime($user->date_registered))); ?></span>
                                tháng <span class="val"><?php echo e(date('m', strtotime($user->date_registered))); ?></span>
                                năm <span class="val"><?php echo e(date('Y', strtotime($user->date_registered))); ?></span>
                            </p>
                            <div class="stamp-placeholder">
                                ...
                                <div class="stamp mb-5">
                                    <img width="250px" height="120px" src="<?php echo e(asset('/images/stamp.png')); ?>" alt="Stamp">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function downloadQRCode() {
            ...
            img.onload = function () {
                ...
                link.href = imgURI;
                link.download = "QR_NhaChua_PhuocLoc_<?php echo e($user->uid_code ?? 'ma-dinh-danh'); ?>.png";
...
<?php echo $__env->make('client.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/client/quyy/detail.blade.php ENDPATH**/ ?>