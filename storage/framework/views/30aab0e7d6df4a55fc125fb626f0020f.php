    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
            ...
            <div class="modal-body px-4 pt-4 pb-3" style="background-color: #fcf9f2;">
                <form id="form-verify" action="<?php echo e(route('client.quyy.check-detail')); ?>" method="POST">
...
</div><?php /**PATH /var/www/html/resources/views/client/quyy/_modal-verify-search.blade.php ENDPATH**/ ?>